...
public class HttpResponse implements Response {
  ...
  public HttpResponse(HttpBase http, URL url, WebPage page, Configuration conf, boolean shouldUsingSelenium)
    ...
    try {
      ...
      if (shouldUsingSelenium) {
        readSeleniumContent(url);
      } else {
  ...
  private void readSeleniumContent(URL url) throws IOException {
